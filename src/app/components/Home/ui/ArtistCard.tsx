...
export default function ArtistCard({
    ...
    return (
        <div onClick={onClick} className="group mx-auto w-full min-w-0 cursor-pointer rounded-xl">
            ...
            <h3 className="mb-0.5 px-2.5 pt-2 text-center font-sans text-base font-bold text-white/70 line-clamp-1">
                {decodeHTMLEntities(artist.name)}
            </h3>

            <p className="select-none truncate px-2.5 pb-2.5 text-center font-sans text-xs font-normal text-gray-400">
